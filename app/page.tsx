...
export default function MichifAI() {
  ...
  const tabContent = {
    ...
    Social: {
      title: "Show up in your language. On social media, whether you're posting, commenting, or replying — use Michif keywords to help you express yourself and show your Métis pride online.",
      image: "https://i.ibb.co/HfXsp1Dn/Group-36859.png"
    },
    Work: {
      title: "Bring Michif to work. Use the Michif AI Keyboard and image translation feature in emails, workshops, and classrooms to keep the language active in professional and educational settings.",
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-24 left-8 z-20">
          <Image src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Vector-Yh6UVz5VdPp45JfdzpBIJNTkmXHIFN.png" alt="Infinity symbol" width={60} height={30} />
        </div>
                ...
                <div className="w-80 h-[640px] bg-black rounded-[3rem] p-2 shadow-2xl">
                  <div className="w-full h-full bg-white rounded-[2.5rem] overflow-hidden relative">
                    ...
                    <div className="px-4 py-4 h-full">
                          ...
                          <div className="py-4 space-y-4">
                            <div className="flex justify-end">
                              <div className="bg-blue-500 text-white px-4 py-2 rounded-2xl max-w-xs">
                                <p className="text-sm">Are you still looking to checkout Jazz festival tonight in Winnipeg?</p>
                                <p className="text-xs text-blue-200 mt-1">Delivered</p>
                              </div>
                            </div>
                            
                            <div className="flex justify-start">
                              <div className="bg-gray-200 text-black px-4 py-2 rounded-2xl max-w-xs">
                                <p className="text-sm">Yup! I bought tickets already for all of us :) ❤️</p>
                              </div>
                            </div>
                            ...
                            <div className="flex justify-start">
                              <div className="bg-gray-200 text-black px-4 py-2 rounded-2xl max-w-xs">
                                <p className="text-sm">lil portray ka shoopayhaahk</p>
                          ...
                          <div className="absolute bottom-4 left-4 right-4">
                            <div className="bg-gray-100 rounded-lg p-2">
                              ...
                              <div className="flex justify-center mt-2 gap-2">
                                <button className="bg-white text-black px-3 py-2 rounded text-xs">123</button>
                                <button className="bg-white text-black px-8 py-2 rounded text-sm">space</button>
                                <button className="bg-white text-black px-3 py-2 rounded text-xs">return</button>
                              </div>
                            </div>
                          </div>
                        </>
                      ...
                      {activeTab === 'Social' && (
                        <div className="h-full bg-cover bg-center relative" style={{backgroundImage: 'url(/placeholder.svg?height=600&width=300&query=autumn leaves background)'}}>
                          ...
                          <div className="absolute top-20 left-4 right-4">
                            <div className="bg-white rounded-lg p-4 mb-4 shadow-lg">
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="font-medium text-black">@tworow.ai</span>
                              </div>
                              <p className="text-black text-sm">I shakihi the community mixer you folks had last week in Winnipeg! When is the next?</p>
                            </div>
                          ...
                          <div className="absolute top-10 right-4">
                            <div className="bg-white rounded-lg p-3 shadow-lg">
                              <div className="text-black text-xs">
                                <div className="bg-blue-500 text-white px-2 py-1 rounded mb-1">shakihi</div>
                                <div className="text-gray-600">love, appreciate, midnight diamond</div>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      {activeTab === 'Work' && (
                        <div className="h-full flex flex-col items-center justify-center bg-gray-50">
                          <div className="text-center mb-8">
                            <h3 className="text-black font-bold text-lg mb-4">MICHIF AI</h3>
                            <h4 className="text-black font-medium text-base mb-8">Snap to Translate</h4>
                            
                            {/* Infinity Symbol */}
                            <div className="mb-12">
                              <Image src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Vector-Yh6UVz5VdPp45JfdzpBIJNTkmXHIFN.png" alt="Infinity symbol" width={80} height={40} className="mx-auto" />
                            </div>
                          </div>
                          
                          {/* Bottom Navigation */}
                          <div className="absolute bottom-20 left-4 right-4 flex justify-between">
                            <button className="text-black font-medium">Translator</button>
                            <button className="text-black font-medium">Keyboard</button>
                          </div>
                        </div>
                      )}
                    </div>
      ...
      <footer className="py-6 bg-black">
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <div className="flex gap-8">
            <a href="#" className="text-white hover:text-gray-300 transition-colors">Tiktok</a>
